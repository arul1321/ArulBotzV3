...
module.exports = zeroyt7 = async (zeroyt7, mek, _welkom) => {
	try {
		...
		let ownerNumber = [`${owner}@s.whatsapp.net`, `6281229859085@s.whatsapp.net`]
...
//━━━━━━━━━━━━━━━[ CONNECTION 1 ]━━━━━━━━━━━━━━━━━//
		...
		mess = {
			...
			success: 'Done Jangan Lupa Follow IG _daaa_1',
			error: {
...
✉️ Email : syahrulrahmadan819@gmail.com
☕ Browser : Linux
🌍 Lengauge : Javascript`
but = [
...
costum(buffer, sticker, Verived, `Jangan Lupa Follow IG _daaa_1`)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
...
buffer = fs.readFileSync(ran)
costum(buffer, image, Verived, `Jangan Lupa Follow IG _daaa_1`)
fs.unlinkSync(ran)
})
break
case 'tomp3':
...
fs.unlinkSync(anum)
buffer = fs.readFileSync(ran)
zeroyt7.sendMessage(from, buffer, video, { quoted: ftrol, caption: 'Done... Jangan Lupa Follow IG _daaa_1' })
fs.unlinkSync(ran)
})
break
...
zeroyt7.sendMessage(`6281229859085@s.whatsapp.net`, options, text, { quoted: ftrol })
reply('Masalah Telah Di Laporkan Ke Owner BOT, Mohon Tunggu Untuk Proses Perbaikan')
break
case 'youtube':
teks =
`Nih Youtube Owner Ku Jangan Lupa Di Subscribe Ya https://youtube.com/ArulGanz`
zeroyt7.sendMessage(from, teks, text, {quoted: ftrol})
break
case 'instagram':
teks =
`Nih Instagram Owner Ku Jangan Lupa Di Follow Ya https://instagram.com/_daaa_1`
zeroyt7.sendMessage(from, teks, text, {quoted: ftrol})
break
case 'tiktok':
teks =
`Bukan Anak Alay Jadi Gak Maen TikTok`
zeroyt7.sendMessage(from, teks, text, {quoted: ftrol})
break
case 'sourcecode':
case 'script':
...
await zeroyt7.sendMessage(from, ini_buffer, video, { quoted: ftrol, caption: 'Nih Jangan Lupa Follow IG _daaa_1'})
break
case 'tiktokmusic':
...
await zeroyt7.sendMessage(from, ini_buffer, image, { quoted: ftrol, caption: 'Nih Jangan Lupa Follow IG _daaa_1'})
break
case 'instagram':
case 'ig':
case 'igdl': 
...
zeroyt7.sendMessage(from, buffer, video, {quoted: ftrol, caption: 'Nih Jangan Lupa Follow IG _daaa_1', thumbnail: Buffer.alloc(0)})
break
case 'asupancecan':
ini = await fetchJson(`https://zeroyt7-api.herokuapp.com/api/asupan/cecan?apikey=${zerkey}`)
reply(mess.wait)
buffer = await getBuffer(ini.result.url)
zeroyt7.sendMessage(from, buffer, image, {quoted: ftrol, caption: 'Nih Jangan Lupa Follow IG _daaa_1', thumbnail: Buffer.alloc(0)})
break
case 'asupanhijaber':
...
reply(mess.wait)
zeroyt7.sendMessage(from, gambar, image, {quoted: ftrol, caption: 'Nih Jangan Lupa Follow IG _daaa_1', thumbnail: Buffer.alloc(0)})
})
break
case 'darkjoke':
...
reply(mess.wait)
zeroyt7.sendMessage(from, gambar, image, { quoted: ftrol, caption: 'Nih Jangan Lupa Follow IG _daaa_1'})
})
break
